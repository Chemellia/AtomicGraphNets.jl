...
@everywhere include("/home/rkurchin/CGCNN_formationenergy/train_fcn_hybridopt.jl")
using DataFrames
...
nums_pts = sort(vcat(nums_pts, nums_pts, nums_pts, nums_pts, nums_pts))
nums_conv = [3]
atom_fea_lens = [32]
pool_types = ["mean"]
crys_fea_lens = [128]
...
CSV.write("convergence_adamw_8knodecay_thenlr001expdecay15step500.csv", output)
